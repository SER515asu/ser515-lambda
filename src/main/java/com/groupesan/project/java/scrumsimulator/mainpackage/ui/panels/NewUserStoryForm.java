...
public class NewUserStoryForm extends JFrame implements BaseComponent {
    ...
    Double[] businessList = {1.0, 2.0, 3.0, 5.0, 8.0, 11.0, 19.0, 30.0, 49.0};
    ...
    private JComboBox<Double> businessCombo = new JComboBox<>(businessList);
    ...
    public void init() {
        ...
        JLabel businessValue = new JLabel("Business Value:");
        myJpanel.add(
                businessValue,
                new CustomConstraints(
